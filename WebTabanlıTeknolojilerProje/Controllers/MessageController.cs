...
using WebTabanlıTeknolojilerProje.Models.Message;
...
namespace WebTabanlıTeknolojilerProje.Controllers
{
    ...
    public class MessageController : BaseController
    {
        ...
        public ActionResult RenderMessage()
        {
            ...
            var currentId = CurrentUserId();
            var mList = context.Messages.Where(x => x.ToMemberId == currentId || x.MessageReplies.Any(y => y.Member_Id == currentId))
